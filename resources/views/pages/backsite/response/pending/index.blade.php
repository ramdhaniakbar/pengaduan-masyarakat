...
@section('title', 'Pengaduan Status Pending')
      ...
      <div class="card">
        ...
        <div class="card-body">
          ...
          <div class="d-flex justify-content-between align-items-center mb-3">
            <h3>Pengaduan Masyarakat Status Pending</h3>
          </div>
          ...
          <table class="table table-striped table-bordered border">
            ...
            <tr>
              ...
              <td>
                <span class="text-capitalize badge text-bg-secondary">{{ $complaint->status }}</span>
              </td>
              <td>
